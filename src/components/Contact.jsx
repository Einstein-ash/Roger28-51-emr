...
// export default SectionWrapper(Hero_test,"hero_test");
...
const Contact = () => {
  ...
  return (
    ...
    <section className={`relative w-full h-screen mx-auto`}>
     <div
        className={`absolute inset-0 top-[10px]  max-w-7xl mx-auto ${styles} flex flex-row items-start gap-5`}
      >
      ...
      <motion.div
        variants={slideIn("right", "tween", 0.2, 1)}
        className='xl:flex-1 xl:h-70% md:h-[550px] h-[450px]'
      >
        <EarthCanvas />
      </motion.div>
    </div>
